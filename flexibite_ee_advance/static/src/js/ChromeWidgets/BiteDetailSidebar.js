odoo.define('flexibite_ee_advance.BiteDetailSidebar', function(require) {
    ...
    class BiteDetailSidebar extends PosComponent { 
        constructor() {
            ...
            useListener('print-x-report', this.PrintPdfReportX);
        ...
        async PrintPdfReportX(){
            return await this.env.pos.do_action('flexibite_ee_advance.pos_x_report',{additional_context:{
